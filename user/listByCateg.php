    ...
    <?php include("./component/top-menu.php") ?>
      ...
      <div class="w-75 mx-auto mt-4">
        ...
        <?php
            ...
            $str = "SELECT * FROM position pos INNER JOIN company_partner cp ON pos.company_id = cp.company_id INNER JOIN job_category jc ON pos.category_id = jc.category_Id WHERE jc.category_name = '$category_name'";
      ...
      <?php }
         if(mysqli_num_rows($result)<1){
            ...
            echo '<script>window.location.replace("http://localhost/assignment_bloggin_job/user/");</script>';
        }   
      ?>
