        ...
        <div class="modal-dialog modal-dialog-centered">
            <div class="modal-content">
                <div class="modal-header">
                    <h1 class="modal-title fs-5" id="exampleModalLabel">(+) Requirement</h1>
                    <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
                </div>

                <form action="../serviceImpl/requirementImpl.php" method="post">
    ...
    <table id="example" class="table table-striped border" style="width:100%">
        ...
        <tbody>
            <?php
                $i = 1;
                include("../connect/connect.php");
                $str = "SELECT * FROM requirement jb INNER JOIN position pos ON jb.position_id = pos.position_id INNER JOIN company_partner cp ON jb.company_id = cp.company_id";
            ...
            <tr>
                ...
                <td>
                    <a href="../serviceImpl/requirementImpl.php?requierment_id=<?php echo $row['requierment_id']; ?>&btnDelete=btnDelete"><i class="fa-solid fa-trash fa-beat"></i></a>
                    <a href="../editComponent/requirementEdit.php?requierment_id=<?php echo $row['requierment_id']; ?>"><i class="fas fa-edit fa-spin fs-5 ms-3" style="color: #0b2db1;"></i></a>
                </td>
            </tr>
            <?php } ?>
        </tbody>
